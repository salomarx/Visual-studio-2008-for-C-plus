...
namespace CLRSketcher {
  ...
  private: System::Windows::Forms::ToolStripButton^  blueToolStripButton;
	...
	private: System::Windows::Forms::ToolStripMenuItem^  lineStyleStripMenuItem;
	...
	private: System::Windows::Forms::ToolStripButton^  dashedStripButton;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lineStyleStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->dashedStripButton = (gcnew System::Windows::Forms::ToolStripButton());
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(7) {this->fileToolStripMenuItem, 
				this->editToolStripMenuItem, this->toolsToolStripMenuItem, this->elementToolStripMenuItem, this->lineStyleStripMenuItem, this->colorToolStripMenuItem, 
				this->helpToolStripMenuItem});
			this->menuStrip1->Location = System::Drawing::Point(0, 0);
			this->menuStrip1->Name = L"menuStrip1";
			this->menuStrip1->Size = System::Drawing::Size(440, 24);
			...
			// 
			// lineStyleStripMenuItem
			// 
			this->lineStyleStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {this->solidToolStripMenuItem, 
				this->dottedToolStripMenuItem, this->dashedToolStripMenuItem});
			this->lineStyleStripMenuItem->Name = L"lineStyleStripMenuItem";
			this->lineStyleStripMenuItem->Size = System::Drawing::Size(65, 20);
			this->lineStyleStripMenuItem->Text = L"L&ine Style";
			this->lineStyleStripMenuItem->DropDownOpening += gcnew System::EventHandler(this, &Form1::lineStyleStripMenuItem_DropDownOpening);
			// 
