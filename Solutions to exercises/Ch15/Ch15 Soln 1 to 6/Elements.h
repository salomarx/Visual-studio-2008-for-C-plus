  ...
  public CElement
{
   public:
      ...
      CLine(CPoint Start, CPoint End, COLORREF aColor, int penStyle);
  ...
  public CElement
{
   public:
      ...
      CRectangle(CPoint Start, CPoint End, COLORREF aColor, int penStyle);
  ...
  public CElement
{
   public:
      ...
      CCurve(COLORREF aColor, int penStyle);
...
class CEllipse: public CElement
{
   public:
      ...
      CEllipse(CPoint Start, CPoint End, COLORREF aColor, int penStyle);
